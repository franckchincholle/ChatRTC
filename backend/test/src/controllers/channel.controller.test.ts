...
app.get(
  '/api/servers/:serverId/channels',
  channelController.getChannelsByServer.bind(channelController)
);
app.get(
  '/api/channels/:id',
...
describe('ChannelController', () => {
  ...
  describe('GET /api/servers/:serverId/channels', () => {
    it('devrait retourner les channels d un serveur', async () => {
      ...
      (channelService.getChannelsByServerId as jest.Mock).mockResolvedValue(
        mockChannels
      );
  ...
  describe('GET /api/channels/:id', () => {
    it('devrait retourner un channel par son ID', async () => {
      ...
      (channelService.getChannelById as jest.Mock).mockResolvedValue(
        mockChannel
      );
